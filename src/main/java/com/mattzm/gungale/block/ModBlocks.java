...
public class ModBlocks {
    public static final Block SALTPETER_ORE = register("saltpeter_ore", new ModOreBlock(3.0f, 1));
    public static final Block SULFUR_ORE = register("sulfur_ore", new ModOreBlock(3.0f, 1));
