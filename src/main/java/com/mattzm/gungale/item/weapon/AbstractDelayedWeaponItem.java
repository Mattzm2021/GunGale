...
public abstract class AbstractDelayedWeaponItem extends AbstractEnergyWeaponItem implements IDelayedWeapon {
    protected AbstractDelayedWeaponItem(@NotNull BasicProperty basicProperty, @NotNull DamageProperty damageProperty, @NotNull RecoilProperty recoilProperty, @NotNull ReloadProperty reloadProperty, @NotNull ADSProperty adsProperty, @NotNull MagProperty magProperty) {
