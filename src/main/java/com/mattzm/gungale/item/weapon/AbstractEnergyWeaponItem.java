...
public abstract class AbstractEnergyWeaponItem extends AbstractAutoWeaponItem {
    protected AbstractEnergyWeaponItem(@NotNull BasicProperty basicProperty, @NotNull DamageProperty damageProperty, @NotNull RecoilProperty recoilProperty, @NotNull ReloadProperty reloadProperty, @NotNull ADSProperty adsProperty, @NotNull MagProperty magProperty) {
